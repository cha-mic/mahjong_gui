...
if __name__ == '__main__':
    ...
    tehai_canvas = Canvas(frame1, bg = "green", width = 40 * 13 , height = 48)
    tsumo_canvas = Canvas(frame1, bg = "green", width = 40,       height = 48)
    label1 = ttk.Label(frame1, text = '牌をクリックして手牌を入力')

    frame1.grid(row = 0, column = 0)
    label1.grid(row = 0, column = 0, columnspan = 13)
    ...
    culc_button.grid(row = 1, column = 15)

    tehai_canvas.grid(row = 1, column = 0, columnspan = 13)
    tsumo_canvas.grid(row = 1, column = 14)
